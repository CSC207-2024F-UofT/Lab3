...
public class Main {
    ...
    private static CountryCodeConverter ccc = new CountryCodeConverter();
    private static LanguageCodeConverter lcc = new LanguageCodeConverter();
    ...
    public static void runProgram(Translator translator) {
        ...
        while (true) {
            ...
            String ccode = ccc.fromCountry(country);
            String language = promptForLanguage(translator, ccode);
            if (language.equals(quit)) {
                break;
            }

            String lcode = lcc.fromLanguage(language);
