...
public class LanguageCodeConverter {
    private Hashtable<String, String> languageToCode = new Hashtable<>();
    private Hashtable<String, String> codeToLanguage = new Hashtable<>();
    ...
    public LanguageCodeConverter(String filename) {
        ...
        try {
            ...
            for (String line : lines) {
                ...
                codeToLanguage.put(split[1], split[0]);
