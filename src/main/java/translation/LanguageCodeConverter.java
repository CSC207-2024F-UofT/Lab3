    ...
    public LanguageCodeConverter(String filename) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                String[] parts = line.split("\t");   // Format: LanguageName \t Alpha2 \t Alpha3
                String languageName = parts[0];
                String alpha2Code = parts[1].toLowerCase();

                languageCodeToLanguage.put(alpha2Code, languageName);
                languageToLanguageCode.put(languageName, alpha2Code);
            }
