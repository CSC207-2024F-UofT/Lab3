        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                for (int i = 0; i < parts.length - 1; i++) {
                    language.append(parts[i]);
                }
                language = new StringBuilder(language.toString().trim());
                languageCodeToLanguage.put(code, language.toString());
                languageToLanguageCode.put(language.toString(), code);
            }
